...
public class BorderStyle : IEquatable<BorderStyle>
{
  ...
  public Border ToOpenXmlBorder()
  {
	...
	if (TopBorderStyle != BorderStyles.None)
	  brd.TopBorder = new((BorderColor.IsNotNullOrEmptyWhiteSpace()) ? new Color() { Rgb = BorderColor } : new Color { Auto = true })
	  { Style = ToOpenXmlBorderStyleValue(TopBorderStyle) };
	if (RightBorderStyle != BorderStyles.None)
	  brd.RightBorder = new((BorderColor.IsNotNullOrEmptyWhiteSpace()) ? new Color() { Rgb = BorderColor } : new Color { Auto = true })
	  { Style = ToOpenXmlBorderStyleValue(RightBorderStyle) };
	if (BottomBorderStyle != BorderStyles.None)
	  brd.BottomBorder = new((BorderColor.IsNotNullOrEmptyWhiteSpace()) ? new Color() { Rgb = BorderColor } : new Color { Auto = true })
	  { Style = ToOpenXmlBorderStyleValue(BottomBorderStyle) };
	if (LeftBorderStyle != BorderStyles.None)
	  brd.LeftBorder = new((BorderColor.IsNotNullOrEmptyWhiteSpace()) ? new Color() { Rgb = BorderColor } : new Color { Auto = true })
